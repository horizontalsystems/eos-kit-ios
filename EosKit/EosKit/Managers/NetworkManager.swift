...
//                        } else {
//                            return Single.error(EosKit.NetworkError.mappingError)
//                        }
//                    case .failure:
//                        if let response = dataResponse.response {
//                            let data = dataResponse.data.flatMap { try? JSONSerialization.jsonObject(with: $0, options: .allowFragments) }
//                            return Single.error(EosKit.NetworkError.serverError(status: response.statusCode, data: data))
//                        } else {
//                            return Single.error(EosKit.NetworkError.noConnection)
//                        }
//                    }
//                }
//    }
...
//            return Single.error(EosKit.NetworkError.invalidUrl)
//        }
//
